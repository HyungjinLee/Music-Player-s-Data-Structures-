/**
*	@mainpage	2018-2 자료구조 프로젝트 - 뮤직플레이어 Ver 1.0.0
*				This is a simple example of Music Player on data structures course.<br>
*
*				- Doxygen GUI 설정법<br>
...
*
*	@date	2018.11.08 (작성일자 쓸 것!)
*	@ 2014104136 이형진. (작성자 이름 쓸 것!)
*
*/
